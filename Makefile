...
BACKEND_BUCKET = "seekasia-migration-${AWS_ACCOUNT_ID}-terraform-backend"
BACKEND_KEY = terraform-monorepo-starter
BACKEND_REGION = ap-southeast-1
BACKEND_PROFILE = default
BACKEND_DYNAMODB_TABLE = "seekasia-migration-${AWS_ACCOUNT_ID}-terraform-lock"

# BACKEND_BUCKET = cmd-seek-migration-2022-terraform-backend
# BACKEND_KEY = terraform-monorepo-starter
# BACKEND_REGION = ap-southeast-1
# BACKEND_PROFILE = default
# BACKEND_DYNAMODB_TABLE = cmd-seek-migration-2022-terraform-lock
